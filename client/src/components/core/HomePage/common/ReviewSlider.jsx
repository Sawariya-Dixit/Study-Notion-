      ...
      <div className="max-w-maxContent lg:max-w-[1200px] mx-auto">
        ...
        >
          {reviews.map((review, i) => (
            <SwiperSlide key={i}>
              <div className="flex flex-col gap-3 bg-[var(--richblack-800)] p-5 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <h1 className="font-semibold text-[var(--richblack-5)]">
                ...
                {/* Review Text */}
                <p className="font-medium text-[var(--richblack-25)] mt-2">
