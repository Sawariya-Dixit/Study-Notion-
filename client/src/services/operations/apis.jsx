const BASE_URL = "https://study-notion-s9h9.onrender.com/api/v1"
...
export const courseEndpoints = {
  ...
  COURSE_CATEGORIES_API: BASE_URL + "/category/all",
  CREATE_COURSE_API: BASE_URL + "/course/createCourse",
  CREATE_SECTION_API: BASE_URL + "/section/createSection",
  CREATE_SUBSECTION_API: BASE_URL + "/subsection/create",
 ...
 DELETE_SECTION_API: BASE_URL + "/section/deleteSection",
  ...
  CREATE_RATING_API: BASE_URL + "/rating/create",
  ENROLL_COURSE_API: BASE_URL + "/course/enroll-course",
}
...
export const catalogData = {
  CATALOGPAGEDATA_API: BASE_URL + "/category/details",
}
// CONTACT-US API
